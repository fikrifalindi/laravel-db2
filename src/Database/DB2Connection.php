...
namespace Fkrfld\DB2\Database;

use PDO;

use Illuminate\Database\Connection;

use Fkrfld\DB2\Database\Schema\Builder;
use Fkrfld\DB2\Database\Query\Processors\DB2Processor;
use Fkrfld\DB2\Database\Query\Processors\DB2ZOSProcessor;
use Fkrfld\DB2\Database\Query\Grammars\DB2Grammar as QueryGrammar;
use Fkrfld\DB2\Database\Schema\Grammars\DB2Grammar as SchemaGrammar;
use Fkrfld\DB2\Database\Schema\Grammars\DB2ExpressCGrammar;

/**
 * Class DB2Connection
 *
 * @package Fkrfld\DB2\Database
 */
class DB2Connection extends Connection
{
     ...
     *
     * @return \Fkrfld\DB2\Database\Schema\Builder
     */
     ...
     *
     * @return \Fkrfld\DB2\Database\Query\Processors\DB2Processor|\Fkrfld\DB2\Database\Query\Processors\DB2ZOSProcessor
     */
