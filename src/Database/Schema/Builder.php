...
namespace Fkrfld\DB2\Database\Schema;
 ...
 * Class Builder
 *
 * @package Fkrfld\DB2\Database\Schema
 */
class Builder extends \Illuminate\Database\Schema\Builder
{
     ...
     *
     * @return \Fkrfld\DB2\Database\Schema\Blueprint
     */
    protected function createBlueprint($table, Closure $callback = null)
    {
        ...
        return new \Fkrfld\DB2\Database\Schema\Blueprint($table, $callback);
    }
}
